const books = [
  { id: 1, level: 'A1', name: 'Schritte plus neu A1.1', thems: [] },
  { id: 2, level: 'A1', name: 'Schritte plus neu A1.2', thems: [] },
  { id: 3, level: 'A2', name: 'Schritte plus neu A2.1', thems: [] },
  { id: 4, level: 'A2', name: 'Schritte plus neu A2.2', thems: [] },
  { id: 5, level: 'B1', name: 'Schritte plus neu B1.1', thems: [] },
  { id: 6, level: 'B1', name: 'Schritte plus neu B1.2', thems: [] },
  {
    id: 7,
    level: 'B1 DTZ',
    name: 'Schritte für schritte',
    thems: [],
  },
  {
    id: 8,
    level: 'B2 Beruf',
    name: 'Einfach besser 500',
    thems: [
      {
        id: 1,
        ...
        words: [
          ...
          },
          {
            ...
            translates: [
              ...
              {
                name: 'свидетельство о завершении средней школы',
                status: false,
              },
              {
                name: 'аттестат о профессиональном образовании',
                status: false,
              },
            ],
            examples: [
      ...
      },
      {
        ...
        words: [
          ...
          },
          {
            ...
            translates: [
              {
                name: 'заниматься профессиональной деятельностью',
                status: true,
              },
